...
#define STRING_CONFIG_H_AUTHOR "(Ed Lake, TwoTrees BLU-5 Bluer Plus)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "TwoTrees BLU-5 Bluer Plus"
...
#define PID_K1     0.95   // Smoothing factor within any PID loop
  ...
  //#define PID_PARAMS_PER_HOTEND // Use separate PID parameters for each extruder (useful for mismatched extruders)
    ...
    #define DEFAULT_Kp_LIST { 20.86, 11.03 }
    #define DEFAULT_Ki_LIST {  1.39,  0.63 }
    #define DEFAULT_Kd_LIST { 78.01, 48.43 }
  #else
    // BLU-5 Bluer Plus M106 S255 (100%fan) with M303 E0 S210 C10
...
#define PIDTEMPBED
  ...
  // Two Trees BLU-5 Bluer Plus M303 E-1 S60 C10
  #define DEFAULT_bedKp  27.94
  #define DEFAULT_bedKi   4.66
  #define DEFAULT_bedKd 111.75
 ...
 */
//#define DEFAULT_AXIS_STEPS_PER_UNIT   { 160,   160, 400, 430 }	// x+y 0.9 deg stepper motors
//#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80.3, 80.3, 400, 430 }	// x+y 1.8 deg stepper motors-stock FW
//#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80.6, 80.4, 400,  90 }    // x+y 1.8 deg stepper motors-stock-RST FW
  #define DEFAULT_AXIS_STEPS_PER_UNIT   { 79.9, 79.78,401.45, 430 } // x+y 1.8 deg stepper motors-measured
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
//#define DEFAULT_MAX_FEEDRATE           { 200, 200,  4, 70 } //stock-RST FW
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 1000, 1000, 100, 1000 } //stock-RST FW
 ...
 */
//stock-RST FW: M204 P1000.00 R1000.00 T1000.00
#define DEFAULT_ACCELERATION           500    // X, Y, Z and E acceleration for printing moves
#define DEFAULT_RETRACT_ACCELERATION   500    // E acceleration for retracts, was 1000 quiet noisy BMG extruder
...
//#define CLASSIC_JERK
  ...
  //S<min_feedrate> T<min_travel_feedrate> B<min_segment_time_us> X<max_xy_jerk> Z<max_z_jerk> E<max_e_jerk>
  //stock-RST FW: M205 S0.00 T0.00 B20000 X10.00 Y10.00 Z0.30 E5.00
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 18, 28.5, -2.35 } // Z was -2.8
...
#define COLOR_BACKGROUND    COLOR_DARK		//Black instead of light blue
...
#define TOUCH_SCREEN
  ...
  #define TOUCH_CALIBRATION_X 16682
  #define TOUCH_CALIBRATION_Y 11115
  #define TOUCH_OFFSET_X        -24
  #define TOUCH_OFFSET_Y        -35
